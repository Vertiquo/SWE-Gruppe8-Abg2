...
/**
 * Komponente f&uuml;r den CSS-Selektor <code>hs-update-verlag</code>
 */
@Component({
...
export class UpdateVerlagComponent implements OnInit {
    // <hs-update-verlag [updateStammdatenform]="updateStammdatenform" [currentValue]="...">
    @Input()
    form!: FormGroup;
